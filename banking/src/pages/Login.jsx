    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-brand-700 to-brand-900 p-4 font-sans">
      <div className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-xl">
        <div className="mb-6 flex items-center gap-2 text-xl font-bold text-brand-700">
          <span className="grid h-9 w-9 place-items-center rounded-lg bg-brand-600 text-white">M</span>
          Meridian Bank
        </div>
        <h1 className="text-lg font-semibold text-gray-900">Sign in to online banking</h1>
        <p className="mt-1 text-sm text-gray-500">Securely access your accounts.</p>
